...
#define _LANGUAGE_AM_H_
    ...
    #define AM_HEAT                 "Տաքացում"
    #define AM_MOVE                 "Շարժել"
    #define AM_HOME                 "Սկզբնական"
    #define AM_PRINT                "Տպել"
    #define AM_EXTRUDE              "Հալեցնել"
    #define AM_FAN                  "Հովացնել"
    #define AM_SETTINGS             "Կարգավորում"
    #define AM_SCREEN_SETTINGS      "Էկրան"
    #define AM_MACHINE_SETTINGS     "Մեքենա"
    #define AM_FEATURE_SETTINGS     "Feature"
    #define AM_SILENT_ON            "Silent On"
    #define AM_SILENT_OFF           "Silent Off"
    #define AM_SHUT_DOWN            "Անջատել"
    #define AM_RGB_SETTINGS         "LED գույներ"
    #define AM_RGB_RED              "Կարմիր"
    #define AM_RGB_GREEN            "Կանաչ"
    #define AM_RGB_BLUE             "Կապույտ"
    #define AM_RGB_WHITE            "Սպիտակ"
    #define AM_RGB_OFF              "LED Off"
    #define AM_GCODE                "Gcode"
    #define AM_CUSTOM               "Custom"
    #define AM_LEVELING             "Հարթեցում"
    #define AM_POINT_1              "Կետ 1"
    #define AM_POINT_2              "Կետ 2"
    #define AM_POINT_3              "Կետ 3"
    #define AM_POINT_4              "Կետ 4"
    #define AM_ABL                  "ABL"
    #define AM_BLTOUCH              "Bltouch"
    #define AM_BLTOUCH_TEST         "Ստուգում"
    #define AM_BLTOUCH_DEPLOY       "Deploy"
    #define AM_BLTOUCH_STOW         "Stow"
    #define AM_BLTOUCH_REPEAT       "Կրկնել"
    #define AM_PROBE_OFFSET         "Offset"
    #define AM_EEPROM_SAVE          "Պահել"
    ...
    #define AM_POWER_OFF            "Անջատել"
    #define AM_TOUCHSCREEN_ADJUST   "Էկրանի զրոյացում"
    #define AM_MORE                 "Ավելին"
    #define AM_SCREEN_INFO          "Տեղեկություն"
    #define AM_WHITE                "Սպիտակ"
    #define AM_BLACK                "Սև"
    #define AM_BLUE                 "Կապույտ"
    #define AM_RED                  "Կարմիր"
    #define AM_GREEN                "Կանաչ"
    #define AM_CYAN                 "Cyan"
    #define AM_YELLOW               "Դեղին"
    #define AM_BROWN                "Շագանակագույն"
    #define AM_GRAY                 "Մոխրագույն"
    ...
    #define AM_PRINTING             "Տպվում է"
    #define AM_READY                "Պատրաստ"
    #define AM_BUSY                 "Ծանրաբեռնված է"
    #define AM_UNCONNECTED          "Տպիչը կցված չէ"
    #define AM_DISCONNECT_INFO      "Հիմա կարող եք կառավարել Ձեր տպիչը համակարգչի միջոցով"
    ...
    #define AM_ADJUST_INFO          "Խնդրում եմ սեղմեք կարմիր կետերին"
    #define AM_ADJUST_OK            "Adjustment Success"
    #define AM_ADJUST_FAILED        "Adjustment failed, Please Try Again"
    #define AM_WARNING              "Զգուշացում"
    #define AM_STOP_PRINT           "Կանգնեցնե՞լ տպումը"
    #define AM_CONFIRM              "Confirm"
    #define AM_TFTSD                "TFT SD"
    #define AM_READ_TFTSD_ERROR     "TFTSD հիշողության սարքը չկա"
    #define AM_TFTSD_INSERTED       "Քարտը տեղադրված է"
    #define AM_TFTSD_REMOVED        "Քարտն հեռացված է"    
    ...
    #define AM_PREHEAT              "Տաքացնել"
    #define AM_PREHEAT_BOTH         "Երկուսը"
    ...
    #define AM_MANUAL_SHUT_DOWN     "Ձեռքով"
    #define AM_UNIFIEDMOVE          "Movemeny"
    #define AM_UNIFIEDHEAT          "Heat&Fan"
    #define AM_COOLDOWN             "Սառեցնել"
